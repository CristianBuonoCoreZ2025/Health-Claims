...
export function TopBar() {
  ...
  return (
    <>
      ...
      <header className="sticky top-0 z-40 h-14 w-full border-b border-(--glass-border) bg-[color-mix(in_srgb,var(--card)_85%,transparent)] backdrop-blur-xl shadow-(--shadow-float)">
