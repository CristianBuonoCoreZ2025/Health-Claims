...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "inline-flex w-fit items-center justify-between gap-1.5 rounded-md border border-input bg-input px-2.5 text-sm whitespace-nowrap outline-none select-none focus-visible:ring-2 focus-visible:ring-ring/25 disabled:cursor-not-allowed disabled:opacity-50 data-placeholder:text-muted-foreground data-[size=sm]:h-7",
        className
      )}
      {...props}
    >
